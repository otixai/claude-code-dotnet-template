...
description: >
  ...
  and testing coverage. Runs after implementer and test-writer are done.
...
- [ ] Acceptance tests use **real dependencies** (WebApplicationFactory
{%- if use_testcontainers %}, Testcontainers{% endif %}) — not mocked repos/services
...
- [ ] Test data uses **{{ fake_data_lib | title }}** for generation — no hardcoded magic values
{%- endif %}
